...
--
-- Hôte : localhost
-- Généré le : jeu. 10 nov. 2022 à 20:14
...
--
-- Base de données : `bddeux_livre_hero`
--
...
INSERT INTO `auteur_livre` (`id`, `auteur_id`, `livre_id`) VALUES
(1, 1, 1),
(2, 2, 1);
...
(5, 'Orientation'),
(6, 'Guérison'),
(7, 'Maîtrise des armes'),
(8, 'Bouclier psychique'),
(9, 'Puissance psychique'),
(10, 'Communication Animale'),
(11, 'Maîtrise psychique de la matière');

-- --------------------------------------------------------

--
-- Structure de la table `lien_chapitre`
--

CREATE TABLE `lien_chapitre` (
  `id` int NOT NULL,
  `no_chapitre_source` int NOT NULL,
  `no_chapitre_destination` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `lien_chapitre`
--

INSERT INTO `lien_chapitre` (`id`, `no_chapitre_source`, `no_chapitre_destination`) VALUES
(1, 1, 85),
(2, 1, 275),
(3, 1, 141),
(4, 2, 343),
...
CREATE TABLE `livre` (
  `id` int NOT NULL,
  `nom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `titre_prologue` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `prologue` text COLLATE utf8mb4_general_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Tunique de Seigneur Kaï verte'),
(2, 'Cape de Seigneur Kaï verte'),
(3, 'Repas'),
(4, 'Carte Géographique'),
(5, 'Casque'),
(6, 'Cotte de mailles'),
(7, 'Potion de guérison'),
(8, 'Couronnes');
...
CREATE TABLE `sauvegarde` (
  ...
  `nom` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `livre_id` int NOT NULL,
  `no_chapitre_rendu` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Structure de la table `sauvegarde_arme`
--

CREATE TABLE `sauvegarde_arme` (
  `id` int NOT NULL,
  `sauvegarde_id` int NOT NULL,
...
--
-- Structure de la table `sauvegarde_discipline`
--
...
--
-- Structure de la table `sauvegarde_objet`
--
...
--
-- Index pour la table `lien_chapitre`
--
ALTER TABLE `lien_chapitre`
  ADD PRIMARY KEY (`id`),
  ADD KEY `no_chapitre_source` (`no_chapitre_source`),
  ADD KEY `no_chapitre_destination` (`no_chapitre_destination`);
...
ALTER TABLE `sauvegarde`
  ADD PRIMARY KEY (`id`),
  ADD KEY `livre_id` (`livre_id`),
  ADD KEY `no_chapitre_rendu` (`no_chapitre_rendu`);

--
-- Index pour la table `sauvegarde_arme`
--
ALTER TABLE `sauvegarde_arme`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sauvegarde_id` (`sauvegarde_id`),
  ADD KEY `arme_id` (`arme_id`);

--
-- Index pour la table `sauvegarde_discipline`
--
ALTER TABLE `sauvegarde_discipline`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sauvegarde_id` (`sauvegarde_id`),
  ADD KEY `discipline_id` (`discipline_id`);

--
-- Index pour la table `sauvegarde_objet`
--
ALTER TABLE `sauvegarde_objet`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sauvegarde_id` (`sauvegarde_id`),
...
--
-- AUTO_INCREMENT pour la table `auteur_livre`
--
ALTER TABLE `auteur_livre`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT pour la table `lien_chapitre`
--
ALTER TABLE `lien_chapitre`
...
--
-- AUTO_INCREMENT pour la table `sauvegarde_arme`
--
ALTER TABLE `sauvegarde_arme`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sauvegarde_discipline`
--
ALTER TABLE `sauvegarde_discipline`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sauvegarde_objet`
--
ALTER TABLE `sauvegarde_objet`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `auteur_livre`
  ADD CONSTRAINT `auteur_livre_ibfk_1` FOREIGN KEY (`auteur_id`) REFERENCES `auteur` (`id`),
  ADD CONSTRAINT `auteur_livre_ibfk_2` FOREIGN KEY (`livre_id`) REFERENCES `livre` (`id`);

--
-- Contraintes pour la table `chapitre`
--
ALTER TABLE `chapitre`
  ADD CONSTRAINT `chapitre_ibfk_1` FOREIGN KEY (`livre_id`) REFERENCES `livre` (`id`);

--
-- Contraintes pour la table `lien_chapitre`
--
ALTER TABLE `lien_chapitre`
  ADD CONSTRAINT `lien_chapitre_ibfk_1` FOREIGN KEY (`no_chapitre_source`) REFERENCES `chapitre` (`no_chapitre`),
  ADD CONSTRAINT `lien_chapitre_ibfk_2` FOREIGN KEY (`no_chapitre_destination`) REFERENCES `chapitre` (`no_chapitre`);
...
ALTER TABLE `sauvegarde`
  ...
  ADD CONSTRAINT `sauvegarde_ibfk_2` FOREIGN KEY (`no_chapitre_rendu`) REFERENCES `chapitre` (`no_chapitre`);

--
-- Contraintes pour la table `sauvegarde_arme`
--
ALTER TABLE `sauvegarde_arme`
  ADD CONSTRAINT `sauvegarde_arme_ibfk_1` FOREIGN KEY (`sauvegarde_id`) REFERENCES `sauvegarde` (`id`),
  ADD CONSTRAINT `sauvegarde_arme_ibfk_2` FOREIGN KEY (`arme_id`) REFERENCES `arme` (`id`);

--
-- Contraintes pour la table `sauvegarde_discipline`
--
ALTER TABLE `sauvegarde_discipline`
  ADD CONSTRAINT `sauvegarde_discipline_ibfk_1` FOREIGN KEY (`sauvegarde_id`) REFERENCES `sauvegarde` (`id`),
  ADD CONSTRAINT `sauvegarde_discipline_ibfk_2` FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`id`);

--
-- Contraintes pour la table `sauvegarde_objet`
--
ALTER TABLE `sauvegarde_objet`
  ADD CONSTRAINT `sauvegarde_objet_ibfk_1` FOREIGN KEY (`sauvegarde_id`) REFERENCES `sauvegarde` (`id`),
  ADD CONSTRAINT `sauvegarde_objet_ibfk_2` FOREIGN KEY (`objet_id`) REFERENCES `objet` (`id`);
COMMIT;
